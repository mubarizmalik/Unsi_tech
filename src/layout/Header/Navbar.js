        ...
        <div className="container d-flex align-items-center justify-content-lg-between position-relative">
          ...
          <div className="dropdown-menu border-0 rounded-custom shadow py-0 bg-white">
            <div className="dropdown-grid rounded-custom width-full">
              ...
              <div className="dropdown-grid-item bg-light">
              ...
              <div className="dropdown-grid-item">
                <h6 className="drop-heading">Digital Marketing</h6>
                {navServicesDigital.map((navLink, i) => (
                  <span key={i + 1}>
                    <Link href={navLink.href}>
                      <a
                        className="dropdown-link px-0"
              ...
              <div className="dropdown-grid-item radius-right-side bg-light">
                <h6 className="drop-heading">UI/UX Design</h6>
                {navServicesDesign.map((navPage, i) => (
                  <span key={i + 1}>
                    <Link href={navPage.href}>
                      <a
                        className="dropdown-link"
